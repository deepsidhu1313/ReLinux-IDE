            ...
            tv.setOnMouseClicked((MouseEvent mouseEvent) -> {
                if (mouseEvent.getClickCount() % 2 == 0) {
                    ...
                    if (item.getValue().exists() && item.getValue().isFile()) {
                        ReLinuxIDE.addTab(item.getValue(), ReLinuxIDE.tabcounter);
                    } else {
                    ...
                    if (item != null && item.getValue() != null && !item.getValue().getName().equalsIgnoreCase("workspace")) {
                        ...
                        if (projectName != null && !(GlobalConstants.selectedProjectFolder.trim().equalsIgnoreCase(projectName.trim()))) {
                            GlobalConstants.selectedProjectFolder = projectName.trim();
                            ReLinuxIDE.loadManifest(new File("workspace/" + GlobalConstants.selectedProjectFolder));
                        }
                    }
                }
            });
